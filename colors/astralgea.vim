...
set background=dark
hi Normal ctermfg=252 ctermbg=235 guifg=#ffffff guibg=NONE
...
hi CursorLine ctermfg=NONE ctermbg=236 cterm=bold guifg=NONE guibg=#064253 gui=bold
hi CursorColumn ctermfg=NONE ctermbg=236 cterm=NONE guifg=NONE guibg=#222222 gui=NONE
hi Visual ctermfg=NONE ctermbg=238 cterm=NONE guifg=NONE guibg=#53060B gui=NONE
hi VisualNOS cterm=underline guifg=fg gui=underline
hi Folded ctermfg=252 ctermbg=236 cterm=NONE guifg=#ffffff guibg=#222222 gui=NONE
hi FoldColumn ctermfg=252 ctermbg=235 cterm=NONE guifg=#ffffff guibg=NONE gui=NONE
hi Title ctermfg=162 ctermbg=NONE cterm=bold guifg=#e242ac guibg=NONE gui=bold
hi StatusLine ctermfg=252 ctermbg=238 cterm=NONE guifg=#ffffff guibg=#222222 gui=NONE
hi StatusLineNC ctermfg=241 ctermbg=236 cterm=NONE guifg=#586374 guibg=#222222 gui=NONE
hi VertSplit ctermfg=236 ctermbg=236 cterm=NONE guifg=#333333 guibg=#222222 gui=NONE
hi LineNr ctermfg=241 ctermbg=236 cterm=NONE guifg=#586374 guibg=#222222 gui=NONE
hi CursorLineNr ctermfg=255 ctermbg=241 cterm=bold guifg=#edf5ff guibg=#586374 gui=bold
hi SpecialKey ctermfg=44 ctermbg=44 cterm=bold guifg=#064253 guibg=NONE gui=bold
hi NonText ctermfg=241 ctermbg=235 cterm=NONE guifg=#586374 guibg=NONE gui=NONE
hi MatchParen ctermfg=197 ctermbg=NONE cterm=bold guifg=#31B6B8 guibg=NONE gui=bold
...
hi Todo ctermfg=252 ctermbg=235 cterm=bold guifg=#ffffff guibg=NONE gui=bold
hi IncSearch ctermfg=235 ctermbg=44 cterm=bold guifg=NONE guibg=NONE gui=bold
hi Search ctermfg=235 ctermbg=23 cterm=NONE guifg=NONE guibg=#56c7ee gui=NONE
hi Pmenu ctermfg=252 ctermbg=236 cterm=NONE guifg=#ffffff guibg=#222222 gui=NONE
hi PmenuSel ctermfg=255 ctermbg=238 cterm=bold guifg=#edf5ff guibg=#222222 gui=bold
hi PmenuSbar ctermbg=236 cterm=NONE guibg=#222222 gui=NONE
hi PmenuThumb ctermbg=241 cterm=NONE guibg=#586374 gui=NONE
hi TabLine ctermfg=252 ctermbg=235 cterm=NONE guifg=#ffffff guibg=NONE gui=NONE
hi TabLineSel ctermfg=235 ctermbg=162 cterm=bold guifg=NONE guibg=#e242ac gui=bold
hi TabLineFill ctermfg=252 ctermbg=235 cterm=NONE guifg=#ffffff guibg=NONE gui=NONE
...
hi DiffAdd ctermfg=44 ctermbg=44 cterm=NONE guifg=NONE guibg=#064253 gui=NONE
...
hi diffAdded ctermfg=44 ctermbg=44 cterm=NONE guifg=NONE guibg=#064253 gui=NONE
...
hi SignColumn ctermfg=252 ctermbg=236 cterm=NONE guifg=#ffffff guibg=#222222 gui=NONE
...
hi GitGutterAdd ctermfg=44 ctermbg=236 cterm=bold guifg=NONE guibg=#222222 gui=bold
hi GitGutterChange ctermfg=162 ctermbg=236 cterm=bold guifg=#e242ac guibg=#222222 gui=bold
hi GitGutterDelete ctermfg=162 ctermbg=236 cterm=bold guifg=#e242ac guibg=#222222 gui=bold
